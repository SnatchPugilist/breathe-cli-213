...
```bash
git clone https://github.com/SnatchPugilist/breathe-cli-213.git
cd breathe-cli-213
python setup.py
```
...
[![Homebrew](https://img.shields.io/badge/homebrew-tap-orange)](https://github.com/SnatchPugilist/breathe-cli-213)
...
<!-- Last updated: 2026-06-06 19:01:40 -->
